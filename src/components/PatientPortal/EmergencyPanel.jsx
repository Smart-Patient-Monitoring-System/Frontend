  ...
  return (
    <div className="space-y-4 sm:space-y-5 md:space-y-6">
      ...
      <div className="bg-red-600 text-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
       ...
       <button
  onClick={() => window.open("https://www.1990.lk/", "_blank")}
  className="w-full lg:w-auto bg-white text-red-600 rounded-xl py-3 px-6 font-bold text-lg flex items-center justify-center gap-3 hover:bg-red-50 transition-colors shadow-lg"
>
