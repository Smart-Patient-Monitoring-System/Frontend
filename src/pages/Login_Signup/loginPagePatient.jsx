    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-[#F8FBFF] to-[#EEF6FF] flex items-center justify-center px-4">
      <div className="w-full max-w-[1400px] grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-10 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start gap-6">
          ...
          {/* ROLE CARD */}
          <div className="w-full max-w-[420px] bg-[#EBF3FE] rounded-2xl p-5 shadow-md">
            <div className="flex items-center gap-4">
              <div className="w-[64px] h-[64px] rounded-full bg-gradient-to-br from-[#2273FF] to-[#4A90FF] flex items-center justify-center">
                <img
                  src={patient}
                  alt="Patient"
              ...
              <div>
                <p className="text-xl font-semibold text-gray-800">Patient</p>
