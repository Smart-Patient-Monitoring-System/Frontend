...
// import axios from "axios";  backend removed
import gtMark from "../../assets/images/gtMark.png";
import heart from "../../assets/images/heart.png";
import patient from "../../assets/images/patient.png";
import { useNavigate } from "react-router-dom";

// const API_URL = "http://localhost:5000/api";  backend removed
...
export default function LoginPagePatient() {
    ...
    const handleLogin = (e) => {
        ...
        // Optional validation (can remove if not needed)
        ...
        const mockToken = "frontend-demo-token";
        ...
        <div className="w-full min-h-screen bg-[#F8FBFF] flex justify-center items-center p-4">
            <div className="w-full max-w-[1800px] grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="flex flex-col items-center lg:items-start gap-10 p-4">
                    ...
                    {/* ROLE CARD */}
                    <div className="w-full max-w-[520px] bg-[#EBF3FE] rounded-3xl shadow-xl p-6">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <p className="text-3xl font-medium">Patient</p>
