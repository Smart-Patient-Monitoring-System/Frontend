      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div>
          <div className="inline-flex items-center gap-2 bg-teal-100 px-3 py-1.5 rounded-full mb-4 sm:mb-6">
            ...
            <span className="text-teal-700 font-medium text-xs sm:text-sm">World-Class Healthcare Technology</span>
          </div>
          ...
          <div className="mb-8 sm:mb-12">
            <button className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:from-teal-700 hover:to-cyan-700 transition-all shadow-lg hover:shadow-xl">
              SIGN-UP
            </button>
          </div>
